  ...
  if (!product) {
    ...
    if (parentProduct) {
      ...
      if (product) {
        ...
        if (!product.growingSeason)
          product.growingSeason = parentProduct.growingSeason;
      ...
      <>
        ...
        <main className="py-5 bg-light min-vh-100">
          <div className="container mb-4">
            <Link
              href="/products"
              className="text-decoration-none text-muted d-flex align-items-center gap-2 small fw-medium"
            >
          ...
          <div className="container">
            <div className="mb-5">
              ...
              <p className="text-secondary mb-4">
                Explore our premium range of {product.title.toLowerCase()} and
                agricultural products. Each product is available in multiple
                varieties to meet your specific requirements.
            ...
            <div className="bg-white p-4 rounded-3 shadow-sm mb-5 d-flex align-items-center flex-wrap gap-3">
              ...
              <div className="d-flex gap-2 flex-wrap flex-grow-1">
                <button className="btn btn-outline-secondary rounded-pill px-4 border-light bg-light text-dark">
                  Origin
                </button>
                <button className="btn btn-outline-secondary rounded-pill px-4 border-light bg-light text-dark">
                  High Demand
      ...
      <main className="bg-white min-vh-100 pb-5">
        ...
        <div className="container mb-5">
          <div className="row g-5">
            ...
            <div className="col-lg-6">
              <div
                className="position-relative w-100 rounded-4 overflow-hidden shadow-sm h-100"
        ...
        {/* <div className="container mb-5">
          ...
          <p className="text-secondary lh-lg mb-0">
            ...
            characteristics. It has been cultivated for generations using both
            traditional and modern farming techniques, resulting in superior
        ...
        <div className="container mb-5">
          <div className="bg-white border shadow-sm rounded-3 p-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            ...
            <Link
              href="/contact"
              className="btn btn-primary px-4 py-2 text-white text-decoration-none"
            >
              Enquire Now
            </Link>
          </div>
            ...
            <div className="col-md-6">
              <div className="bg-light p-3 rounded-3 d-flex align-items-center gap-3 border">
                <div
                  ...
                  style={{ width: 48, height: 48, backgroundColor: "#133F40" }}
                >
                ...
                <div>
                  ...
                  <p className="text-muted small mb-0">
                    We deliver worldwide with reliable logistics partners
                  </p>
                </div>
              </div>
            </div>
